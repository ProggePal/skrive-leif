...
async function callApi(text) {
  try {
    const response = await fetch("https://my-api-proxy.palpeds.workers.dev", {
      method: "POST",
      headers: {
    ...
    while (true) {
      ...
      console.log("Streaming chunk:", chunk); // Stream output for debugging
      accumulatedContent += chunk;
    }

    return accumulatedContent; // Process the complete response as needed
  } catch (error) {
